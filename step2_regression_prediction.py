...
# 路径
validation_path = '/mmx/unimol/csv/experiment_buy.csv'
output_csv = '/mmx/unimol/csv/experiment_buy_cleaned.csv'
...
clf.save_predict(data=data, dir=save_dir, prefix='step2_prediction_experiment_buy')
